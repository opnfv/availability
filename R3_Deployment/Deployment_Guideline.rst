...
Different moduels, such as hardware,VIM,VMs and etc, will be included, and HA
...
a cluster, and the compute nodes can be in one cluster.
...
of congress and doctor can be one of them, in which doctor provides quickly notivication
...
discuss the detail of the storage HA deployment in section 
...
Figure 8 shows a overall architecture for the HA deployment of ARNO. 
